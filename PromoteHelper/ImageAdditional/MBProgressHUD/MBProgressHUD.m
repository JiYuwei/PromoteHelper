...
- (id)initWithView:(UIView *)view 
{
	...
	id me = [super initWithFrame:view.bounds];
...
- (void)updateIndicators
{
	...
	if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator)
    {
		...
		[self setIndicator:ActivityIndicatorView];
...
- (void)layoutSubviews 
{
    ...
    CGSize labelSize = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(bounds.size.width-margin, bounds.size.height)];
	...
	indicatorF.origin.y = yPos-margin/2;
    ...
    totalSize.width = totalSize.width > 75?totalSize.width:75;
	self.size = totalSize;
}
